...
#ifndef NANDINA_EXPERIMENT_WIDGET_SWITCH_HPP
#define NANDINA_EXPERIMENT_WIDGET_SWITCH_HPP
...
{
    class Switch: public primitives::Pressable {
    public:
        explicit Switch(
            std::string label,
            bool checked = false,
        ...
        void set_override(theme::SwitchRecipeRule rule);
        [[nodiscard]] auto visual_state() const -> theme::SwitchVisualState;
        [[nodiscard]] auto resolved_style() const -> theme::ResolvedSwitchStyle;
    ...
    private:
        ...
        std::optional<theme::SwitchRecipeRule> override_;
...
#endif // NANDINA_EXPERIMENT_WIDGET_SWITCH_HPP
